...
- **~3% of `order_customer` orders have NO rows in this table** (65,870 orders / ~$993K calculated net in the 90 days to 2026-07-23 — typical order sizes, not voids-only). Line-level totals therefore undercount. Logged as a data-mart gap; under investigation.

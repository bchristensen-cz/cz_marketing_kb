...
-- 2026-08-24: parent gained week_beginning_ly / week_ending_ly (each = its base column - 364 days).
-- View text unchanged - select * picked them up; no redeploy was needed.

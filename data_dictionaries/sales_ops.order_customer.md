...
| Refresh | Hourly at minute :02, inside `begin transaction` / `commit transaction` (live 2026-08-25 13:02 MT). Intraday runs (8am–11pm MT) reload **today only**. 4am: **8 days as deployed 2026-08-26 13:49 MT**, with a steward change pending that makes it **all history from 2018-08-07** — see the pending-change block above; Monday 4am 5 weeks and 1st-of-month 4am ~13 months are commented out in that pending version. Hours 0–3 and 5–7 skip. Delete + insert by `business_date >= start_date`. |

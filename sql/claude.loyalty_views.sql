...
--   * Views, not tables — EXCEPT loyalty_user, materialized 2026-09-01 (see that file).
--     The whole point ledger is 11.6M rows / ~1.5 GB, so even the FIFO
...
-- =====================================================================================
-- 1. claude.loyalty_user — MOVED to sql/claude.loyalty_user.sql (2026-09-01).
--    Now a TABLE rebuilt daily at 04:30 America/Denver by scheduled query, not a view.
--    The views below still join it by name; nothing else changed.
-- =====================================================================================
